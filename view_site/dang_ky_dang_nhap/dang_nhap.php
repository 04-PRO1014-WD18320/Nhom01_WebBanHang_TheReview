        ...
        <div class="d-grid align-items-center justify-content-center" >
            ...
            <form class="col-lg-5 col-md-5 col-sm-10 p-5 needs-validation" action="dang_ky_dang_nhap.php" class="was-validated" method="POST">
                ...
                <div class="form-group">
                    <h5>Tài khoản</h5>
                    <input type="text" name="" id="validationCustom01" class="form-control my-2" placeholder="Vui lòng nhập tài khoản" >
                    
                    <h5>Mật khẩu</h5>
                    
                    <input type="password" name="" id="" class="form-control my-2" placeholder="Vui lòng nhập mật khẩu" >
