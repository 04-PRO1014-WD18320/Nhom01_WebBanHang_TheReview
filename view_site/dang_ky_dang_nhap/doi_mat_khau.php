            ...
            <div class="row align-items-center" style="background-color: white; width:80%; margin-left:10%; margin-top: 15vh;margin-bottom: 20vh;height:auto; border-radius: 20px;">
                ...
                <form class="col-lg-5 col-md-5 col-sm-10 p-5 needs-validation" action="dang_ky_dang_nhap.php" class="was-validated" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <h5>Mật khẩu</h5>
                        <input type="password" id="mat_khau" name="mat_khau" class="form-control my-2" placeholder="Vui lòng nhập mật khẩu" minlength="4" maxlength="20" required>
                        <h5>Nhập lại mật khẩu</h5>
                        <input type="password" name="re-password" id="" class="form-control my-2" placeholder="Vui lòng nhập lại mật khẩu" minlength="4" maxlength="20" required>
                    </div>
