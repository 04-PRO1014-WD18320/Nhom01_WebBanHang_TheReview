                    ...
                    <div id="carouselExampleIndicators" class="carousel slide mt-4">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="public/asset/macbook.jpeg" style="height: 25rem" class="d-block img-slider" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="public/asset/macbook1.jpeg" style="height: 25rem" class="d-block img-slider" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="public/asset/macbook2.jpeg" style="height: 25rem" class="d-block w-100 img-slider" alt="...">
                            </div>
                        </div>
