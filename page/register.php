...
background-image: linear-gradient(43deg, #4158D0 0%, #C850C0 46%, #FFCC70 100%);
 height:auto">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-10 p-5">
                                ...
                                <h5>Email</h5>
                                <input type="mail" name="email" id="" class="form-control my-2"
                                    placeholder="Vui lòng nhập email" required>
                                <h5>Số điện thoại</h5>
                                <input type="number" name="phone" id="" class="form-control my-2"
                                  ...
                                  <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <img class="mx-auto d-block my-3" src="../asset/logo.png">
                                        <ul>
                            ...
                            <input disabled id="submitt" type="submit" name="submitRegister" class="btn btn-danger mb-3" value="Đăng ký" >
                        </div>
                </form>
    ...
    <!-- <script src="../action/bootstrap.bundle.min.js" defer></script> -->
